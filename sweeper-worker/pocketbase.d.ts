...
import type PocketBase from '@pocketbase/pocketbase';
import type { RecordService } from '@pocketbase/pocketbase';
...
export type SettingsResponse<Tvalue = unknown, Texpand = unknown> = Required<SettingsRecord<Tvalue>> &
    BaseSystemFields<Texpand>;
export type SweepJobResultsResponse<Toutput = unknown, Texpand = unknown> = Required<SweepJobResultsRecord<Toutput>> &
    BaseSystemFields<Texpand>;
export type SweepJobsResponse<Tpatterns = unknown, Texpand = unknown> = Required<SweepJobsRecord<Tpatterns>> &
    BaseSystemFields<Texpand>;
